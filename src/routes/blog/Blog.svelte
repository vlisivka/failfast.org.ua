...
<SvelteSeo
  title="Fail Fast: {frontmatter.title}"
  ...
  openGraph={{
    ...
    title: "Fail Fast: " + frontmatter.title,
    description: frontmatter.excerpt,
    url: "https://failfast.org.ua" + request.permalink,
    images: [
  ...
  jsonLd={{
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://failfast.org.ua" + request.permalink,
      },
      "headline": "Fail Fast: " + frontmatter.title,
      "image": [ frontmatter.image ],
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://failfast.org.ua/public/images/thumbs/vlisivka-photo_t.png"
        }
      }
  }}
/>
